...
function filtrarGastosWeb(evento){
    ...
    let nuevaEtiquetasTiene =[];
    if(etiquetasTiene){
        nuevaEtiquetasTiene = gestionPresupuesto.transformarListadoEtiquetas(etiquetasTiene);  
    }
    let datosFiltrados = {
    ...
    mostrarGastoWeb('listado-gastos-completo',filtradoGasto);
}
